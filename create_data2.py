...
def get_data_list(infodata_path, list_path, zhvoice_path):
    ...
    f_train = open(os.path.join(list_path, 'train_list2.txt'), 'w')
    f_test = open(os.path.join(list_path, 'test_list2.txt'), 'w')
...
if __name__ == '__main__':
    get_data_list('dataset/zhvoice/text/infodata2.json', 'dataset',
